...
import { ChartRadialStacked } from "./_components/radial-chart-stacked";
import { ChartPieDonut } from "./_components/pie-chart-donut";
        ...
        <div className="flex flex-1 flex-col">
          <div className="@container/main flex flex-1 flex-col gap-2">
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
              ...
              <div className="flex flex-col md:flex-row px-4 lg:px-6 gap-4">
                <ChartRadialStacked />
                <ChartPieDonut />
              </div>
            </div>
